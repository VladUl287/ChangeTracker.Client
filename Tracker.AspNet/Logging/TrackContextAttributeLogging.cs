...
{
    [LoggerMessage(Level = LogLevel.Debug, Message = "Options builded for Action '{ActionName}'")]
    public static partial void LogOptionsBuilded(this ILogger logger, string actionName);
