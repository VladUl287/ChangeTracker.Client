...
public static partial class RequestFilterLogging
{
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "Request validation failed: Not valid cache control directive detected. TraceId - {TraceId}")]
    public static partial void LogNotValidCacheControlDirective(this ILogger logger, string traceId);
